...
個人データの管理者はtuvi.educationの所有者です。管理者へは contact@tuvi.education にてご連絡いただけます。
...
- 異議申し立て/制限:contact@tuvi.education へメールで。
...
アプリにアクセスできない場合は、公開ページからアカウント削除をリクエストできます: [Tuvi アカウントを削除 (Web フォーム)](./delete-account/).

## AI の使い方についてさらに

AI で何を生成し、どのように生成し、教師として何を決めるのかについては、[AI 利用に関する透明性ページ](../ia/)をご覧ください。
