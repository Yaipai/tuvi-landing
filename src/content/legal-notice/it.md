...
Il titolare di questo sito web è una persona fisica con residenza in Spagna. In conformità con la normativa vigente, i dati di contatto vengono forniti di seguito.
...
Questo sito web è ospitato sui server di Cloudflare, Inc., con centri dati nell'Unione Europea. Maggiori informazioni su cloudflare.com.
...
Il servizio si trova in fase beta e viene offerto "così com'è", senza garanzie di disponibilità, continuità o assenza di errori. Il titolare non si assume responsabilità per i danni che potrebbero derivare dall'uso del servizio.
